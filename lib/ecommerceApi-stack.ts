...
export class ECommerceApiStack extends cdk.Stack {
  ...
  private createCognitoAuth() {
    ...
    this.customerPool.addDomain('CustomerDomain', {
      cognitoDomain: {
        domainPrefix: 'biga-customer-service'
      }
    });

    this.adminPool.addDomain('AdminDomain', {
      cognitoDomain: {
        domainPrefix: 'biga-admin-service'
      }
    });
  ...
  private createOrdersService(props: ECommerceApiStackProps, api: apigateway.RestApi) {
    ...
    // Modelo que vai ensinar o API Gateway nessa operacao a validar a operacao olhando o body
  ...
  /**
   * Na stack ECommerceApiStack, crie o validador da requisição para a criação e alteração de produtos, com as seguintes regras:

    Perguntas dessa tarefa
    Cite uma vantagem para se utilizar a validação de campos da requisição no API Gateway.
   */
  private createProductsService(props: ECommerceApiStackProps, api: apigateway.RestApi) {
    ...
    // /products
    const productsResource = api.root.addResource('products'); // Recurso que representa o serviço de produtos
