...
export class OrdersAppStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: OrdersAppStackProps) {
    ...
    writeThottleEventsMetric.createAlarm(this, 'WriteThrottleEvents', {
    ...
    orderAlarmsTopic.addSubscription(new subs.EmailSubscription('felipebigarellidantasdacosta@gmail.com'));
